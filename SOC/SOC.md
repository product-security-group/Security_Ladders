...
| **[IR.4]** |`N\A`|`N\A` |Proposes changes to incident response exercises|<ins>**Leads**</ins> incicdent response exercises| <ins>**Defines**</ins> ... |
...
| **[IT.3]** |`N\A` |`N\A`|Proposes changes to intelligence feeeds|Has <ins>**Leads**</ins> changes...| Has <ins>**Defines**</ins> changes...|
| **[IT.4]** |`N\A` |`N\A`|`N\A`|Participates in intelligence sharing activities| <ins>**Leads**</ins> intelligence...|

<!--- This should evewntually be its own track --->
